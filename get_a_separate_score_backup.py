...
pred_path = 'data/metrics/open-eqa-v0-gpt-4-vision-preview-123-metrics.json'
gt_path_length_path = 'data/gt_path_length.json'
path_length_path = 'data/path_length.json'

with open(gt_path_length_path, 'r') as f:
    gt_path_length_map = json.load(f)
with open(path_length_path, 'r') as f:
    path_length_map = json.load(f)
